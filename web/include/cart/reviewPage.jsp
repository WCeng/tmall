<%@ page language="java" contentType="text/html; charset=UTF-8"
 	...
 	<div class="reviewDiv">
        <div class="reviewProductInfoDiv">
            <div class="reviewProductInfoImg">
                <img width="100px" class="reviewProductImg" height="100px"
            ...
            <div class="reviewProductInfoRightDiv">
                ...
                <table class="reviewProductInfoTable">
                    <tr>
                        <td width="75px">价格:</td>
                        <td>
                            <span class="reviewProductInfoTablePrice">￥<fmt:formatNumber type="number" value="${p.promotePrice}" minFractionDigits="2"/></span> 元
                        </td>
                    </tr>
                    <tr>
                        <td>配送</td>
                ...
                <div class="reviewProductInfoRightBelowDiv">
                    ...
                    <span class="reviewProductInfoRightBelowText">
                        现在查看的是 您所购买商品的信息于
                   		<fmt:formatDate value="${o.createDate}" pattern="yyyy年MM月dd日"/>下单购买了此商品
                    </span>
                </div>
            </div>
        ...
        <div class="reviewStasticsDiv">
            <div class="reviewStasticsLeft">
                ...
                <div class="reviewStasticsLeftContent">累计评价
                    <span class="reviewStasticsNumber">${p.reviewCount}</span>
                </div>
    ...
    <script>
    	$(function(){
    		$("div.makeReviewDiv form").submit(function(){
