<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="confirmPayPageDiv">
        ...
        <div class="confirmPayOrderItemDiv">
            ...
            <table border="0" class="confirmPayOrderItemTable">
                <thead>
                    <tr>
                        <th colspan="2">宝贝</th>
                ...
                <c:forEach items="${o.orderItems}" var="oi">
                    <tr>
                        <td>
                            <img width="50px" src="img/productSingle_middle/${oi.product.firstProductImage.id}.jpg"></img>
                        </td>
                        ...
                        <td>${oi.number}</td>
                        <td>
                            <span class="confirmPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.product.promotePrice*oi.number}" minFractionDigits="2"/></span>
                        </td>
            ...
            <table class="confirmPayOrderDetailTable">
                <tbody>
                    <tr>
                        <td>订单编号：</td>
                        <td>${o.orderCode }
                            <img src="img/site/confirmOrderTmall.png" width="23px">
                        </td>
                    </tr>
                    <tr>
                        <td>卖家昵称：</td>
