...
<div class="boughtDiv">
        ...
        <div class="orderListItem">
            ...
            <table border="0" oid="${o.id }" orderstatus="${o.status }" class="orderListItemTable">
                <tbody>
                    <tr class="orderListItemFirstTR">
                        <td colspan="2">
                            <b><fmt:formatDate value="${o.createDate}" pattern="yyyy-MM-dd"/></b>
                    ...
                    <tr class="orderItemProductInfoPartTR" >
                        <td class="orderItemProductInfoPartTD"><img width="80px" height="80px" src="img/productSingle_middle/${oi.product.firstProductImage.id}.jpg"></td>
