				...
				<div>
					<div class="panel panel-warning addPictureDiv">
						...
						<div class="panel-body">
							<form method="post" action="admin_productImage_add"
							enctype="multipart/form-data" class="addFormSingle">
								<table class="addTable">
									...
									<tr>
										<td><input value="${p.id }" name="pid" type="hidden">
											<input value="type_single" name="type" type="hidden">
											<button class="btn btn-success" type="submit">提交</button></td>
									</tr>
								</table>
							</form>
						</div>
					...
					<table
						...
						<tbody>
							<c:forEach items="${pisSingle}" var="pi">
								<tr>
									<td>${pi.id}</td>
									<td><a href="img/productSingle/${pi.id}.jpg" title="点击查看原图"><img height="50px"
